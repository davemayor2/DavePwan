...
const IndexPage = () => {
  ...
  const lands = [
    ...
    },
    {
      ...
      location: "Anambra",
      description: "Welcome to Lavender Courts Awka – where luxury meets affordability in one of Anambra's most promising locations. Located at Ndiukwuenu, Awka, this estate is perfect for families, investors, and developers looking for a premium buy-and-build opportunity.",
      imageAlt: "Lavender Courts",
      src: lavenderCourts,
      subscriptionFormUrl: "/downloads/LAVENDER_COURTS_SUBS_FORM.pdf",
      flyerUrl: "/downloads/lavenderCourts.jpeg",
      subscriptionFormFileName: "Lavender_Courts_Awka_Subscription_Form.pdf",
    ...
    },
    {
      ...
      location: "Imo",
      description: "Elite Eastland Phase 2 is a prime estate located in Umuelu, Umuagwo, Owerri, along the Port Harcourt–Owerri Expressway. Surrounded by key landmarks and just minutes from Obinze Army Barracks, it offers high ROI potential. The estate is fully fenced, plotted, and comes with a Deed of Assignment and Registered Survey, with instant allocation and documents ready within three months.",
